...
final homeRepositoryProvider = Provider<HomeRepository>(
  (Ref ref) => HomeRepositoryImpl(ref.watch(homeRemoteDataSourceProvider)),
);

final getHomeSectionsUseCaseProvider = Provider<GetHomeSectionsUseCase>(
  (Ref ref) => GetHomeSectionsUseCase(ref.watch(homeRepositoryProvider)),
);

final getJustForYouPageUseCaseProvider = Provider<GetJustForYouPageUseCase>(
  (Ref ref) => GetJustForYouPageUseCase(ref.watch(homeRepositoryProvider)),
);
